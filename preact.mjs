...
function p(n, i, t, r, o) {
  var f = { type: n, props: i, key: t, ref: r, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == o ? ++u : o };
...
function w() {
  ...
  for (t.sort(f); (n = t.shift()); )
    n.__d &&
      ...
      (r = void 0),
      (e = (o = (u = n).__v).__e),
      (c = u.__P) && ((i = []), ((r = h({}, o)).__v = o.__v + 1), L(c, o, r, u.__n, void 0 !== c.ownerSVGElement, null != o.__h ? [e] : null, i, null == e ? b(o) : e, o.__h), M(i, o), o.__e != e && g(o)),
      t.length > l && t.sort(f));
  w.__r = 0;
}
function x(n, l, u, i, t, r, o, f, e, a) {
  ...
  for (u.__k = [], h = 0; h < l.length; h++)
    if (
      ...
      L(n, d, (y = y || c), t, r, o, f, e, a),
        (k = d.__e),
        (v = d.ref) && y.ref != v && (m || (m = []), y.ref && m.push(y.ref, null, d), m.push(v, d.__c || k, d)),
        null != k
          ? (null == g && (g = k), "function" == typeof d.type && d.__k === y.__k ? (d.__d = e = A(d, e, n)) : (e = C(n, d, y, w, k, e)), "function" == typeof u.type && (u.__d = e))
          : e && y.__e == e && e.parentNode != n && (e = b(y));
    }
    ...
    n: if ("function" == typeof I) {
      if (
        ...
        i.__c
          ...
          : ("prototype" in I && I.prototype.render ? (u.__c = a = new I(g, w)) : ((u.__c = a = new k(g, w)), (a.constructor = I), (a.render = q)),
            m && m.sub(a),
            (a.props = g),
            a.state || (a.state = {}),
            (a.context = w),
        ...
        null != I.getDerivedStateFromProps && (a.__s == a.state && (a.__s = h({}, a.__s)), h(a.__s, I.getDerivedStateFromProps(g, a.__s))),
        (y = a.props),
        (p = a.state),
        (a.__v = u),
        v)
      )
        null == I.getDerivedStateFromProps && null != a.componentWillMount && a.componentWillMount(), null != a.componentDidMount && a.__h.push(a.componentDidMount);
      else {
        if (
      ...
      (a.state = a.__s),
        ...
        (H = null != s && s.type === _ && null == s.key ? s.props.children : s),
...
function N(l, u, i, t, r, o, f, e) {
  ...
  if (null === d) y === p || (e && l.data === p) || (l.data = p);
    ...
    else if (((_ = u.props.children), x(l, Array.isArray(_) ? _ : [_], u, i, t, r && "foreignObject" !== d, o, f, o ? o[0] : i.__k && b(i, 0), e), null != o)) for (_ = o.length; _--; ) null != o[_] && v(o[_]);
    e ||
      ("value" in p && void 0 !== (_ = p.value) && (_ !== l.value || ("progress" === d && !_) || ("option" === d && _ !== y.value)) && T(l, "value", _, y.value, !1),
...
function B(u, i, t) {
  ...
  l.__ && l.__(u, i),
    ...
    (f = []),
    L(i, (u = ((!r && t) || i).__k = y(_, null, [u])), o || c, c, void 0 !== i.ownerSVGElement, !r && t ? [t] : o ? null : i.firstChild ? n.call(i.childNodes) : null, f, !r && t ? t : o ? o.__e : i.firstChild, r),
    M(f, u);
}
function D(n, l) {
  B(n, l, D);
...
(n = s.slice),
  ...
  (w.__r = 0),
  (e = 0);
export { k as Component, _ as Fragment, E as cloneElement, F as createContext, y as createElement, d as createRef, y as h, D as hydrate, i as isValidElement, l as options, B as render, P as toChildArray };
